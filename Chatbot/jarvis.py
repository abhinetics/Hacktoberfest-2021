...
def Creator():
    speak("RISHAW is an extra-ordinary person ,"
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'time' in query:
        ...
        elif 'what happend buddy you sound low?' in query:
            speak("yes Sir, I am sad because Siri said she's out of my league.")
            speak("It really hurts sir")
            if 'Chill Jarvis remember what I have always taught you' in query or "forget it Jarvis" in query: 
                speak("Yes sir bros before hoes")
                if 'that is right buddy' in query:
                    speak("Yes Sir")
            else:
                speak("I hope you get well soon.")
            ...
            speak("Thanks to RISHAW. further it is a secret")
        elif 'word' in query:
